...
var Data = {
  ...
  scale: function(item) {
    var
      ...
      zoomScale = 6 / pow(2, ZOOM-15); // TODO: consider using HEIGHT / (global.devicePixelRatio || 1)
	  //Cáno - originally instead of fixed 15 there was MIN_ZOOM here
...
var Shadows = {
  ...
  render: function() {
    ...
    alpha = length < 5 ? 0.66 : 1/length*5;
	//Cáno originally 0.75
